...
if __name__ == "__main__":
    ...
    if random_points_number >= 1:
        ...
        for i in sampled_points:
            ...
            m_fix = external_ref(m=m_init,x=i,extra_logic_function=problem_logic_column,dict_extvar=reformulation_dict,tee=False)
