...
if __name__ == "__main__":
    ...
    if random_points_number >= 1:
        ...
        for i in sampled_points:
            ...
            m_fix = external_ref(m=m_init,x=i,extra_logic_function=problem_logic_math,dict_extvar=reformulation_dict,tee=False)
    ...
    # m_fixed = external_ref(m=model,x=initialization,extra_logic_function=problem_logic_math,dict_extvar=reformulation_dict,tee=False)
    ...
    # start = time.time()
    # D_SDAsol,routeDSDA,_=solve_with_dsda(model_function=build_math,model_args={'NT':15},starting_point=initialization,ext_dict=ext_ref,ext_logic=problem_logic_math, k='Infinity',provide_starting_initialization=True,feasible_model='dsda', subproblem_solver=nlp_solver, iter_timelimit=100,tee=False,global_tee=False)
    # end = time.time()
    ...
    # #SOLVE WITH MINLP
    # model = build_math_minlp_gdp(15,initialization)
